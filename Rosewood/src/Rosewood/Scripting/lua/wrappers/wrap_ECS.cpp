...
namespace Rosewood
{
    ...
    wrap_ECS::wrap_ECS(lua_State* L)
    {
        ...
        ns.new_usertype<Animation2D>("Animation2D",
        ...
        ns.new_usertype<Offset2D>("Offset2D",
            "Pivot", &Offset2D::Pivot,
            "FlippedX", &Offset2D::FlippedX,
            "FlippedY", &Offset2D::FlippedY
        );

        ns.new_usertype<TagComponent>("TagComponent",
        ...
        ns.new_usertype<SpriteRenderComponent>("SpriteRenderComponent",
        ...
        ); //Remove reference if it causes memory segmentation error.
