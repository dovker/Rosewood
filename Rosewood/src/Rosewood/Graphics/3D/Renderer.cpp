...
//    }
    ...
    void Renderer::Init()
    {
        ...
        s_Buffer.FrameGBuffer = Framebuffer::Create({Application::Get().GetWindow().GetWidth()*2, Application::Get().GetWindow().GetHeight()*2, 5, 1, false, {TexChannelType::FLOAT, TexChannelType::UNSIGNED_BYTE, TexChannelType::FLOAT, TexChannelType::FLOAT, TexChannelType::FLOAT}});
